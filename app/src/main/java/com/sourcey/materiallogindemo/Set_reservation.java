...
import com.sourcey.materiallogindemo.adapter.gridAdapter;

/**
 * Created by Aneh on 3/22/2015.
 */
public class Set_reservation extends Fragment {
    ...
    RecyclerView.Adapter mAdapte;

    final Set_reservation context = this;
    private Button button_add, button_cancel;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View set_re = inflater.inflate(R.layout.set_reservation, container, false);

        button_add = (Button) set_re.findViewById(R.id.add_pay);
        button_cancel = (Button) set_re.findViewById(R.id.cancel);


        // Calling the RecyclerView
        mRecyclerView = (RecyclerView)set_re.findViewById(R.id.recycler_view);

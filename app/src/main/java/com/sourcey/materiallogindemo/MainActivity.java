...
import com.sourcey.materiallogindemo.adapter.TabsPagerAdapter;
...
public class MainActivity extends ActionBarActivity implements android.app.ActionBar.TabListener,
    ...
    // Tab titles
    private String[] tabs = {"Menu", "Reserve", " Login", "Web"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNavItems.add(new NavItem("Login", R.drawable.about));
